...
- **[values.yaml](values.yaml)**: the applications inventory, see below
- **[templates/applications.yaml](templates/applications.yaml)**: the single template that renders every `Application`
...
- **[`argocd_app_of_apps` module](https://github.com/ConsciousML/terragrunt-template-catalog-eks/tree/main/modules/argocd_app_of_apps)** (catalog): provisions the root `Application` (see [`app-of-apps.yaml`](../app-of-apps.yaml)) that points at this chart and sets `appParams`
