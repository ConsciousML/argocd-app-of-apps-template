...
- **[templates/network-policy.yaml](templates/network-policy.yaml)**: one `CiliumNetworkPolicy` per component (single-binary, gateway, canary, chunks-cache, results-cache)
