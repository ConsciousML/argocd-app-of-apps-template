...
- **[templates/network-policy-hubble-relay.yaml](templates/network-policy-hubble-relay.yaml)**, **[templates/network-policy-hubble-ui.yaml](templates/network-policy-hubble-ui.yaml)**: `CiliumNetworkPolicy` for each, colocated here since both ship with this chart
