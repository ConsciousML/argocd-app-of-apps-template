...
5. Review [`manifests/network-policies/cluster-wide`](manifests/network-policies/cluster-wide) and add the namespace to `default-deny.yaml`'s `values` list, plus any other policy it needs. Ensure it works.
